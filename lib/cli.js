...
var readFileAsync = _bluebird.Promise.promisify(_fs.readFile); /* eslint no-console:0 */
...
var IsSatire = function () {
  ...
  (0, _createClass3.default)(IsSatire, [{
    ...
    value: function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.t2 = JSON;
                _context2.next = 6;
                return readFileAsync('data/known.json', 'utf-8');
              ...
              case 6:
                ...
                _context2.t8 = JSON;
                _context2.next = 15;
                return readFileAsync('data/fingerprint.json', 'utf-8');
      ...
      return function configurationFor(_x3) {
        return ref.apply(this, arguments);
      };
    }()
  }, {
    ...
    value: function () {
      ...
      return function analyzePaths(_x4, _x5) {
        return ref.apply(this, arguments);
      };
    }()
    ...
    value: function () {
      ...
      return function findKeywords(_x11, _x12) {
        return ref.apply(this, arguments);
      };
    }()
    ...
    value: function () {
      ...
      return function calculateLikelihood(_x15) {
        return ref.apply(this, arguments);
      };
    }()
